...
@Component({
  selector: "koppr-pot",
  templateUrl: "./pay-allowance.component.html",
  styleUrls: ["./pay-allowance.component.scss"]
})
export class PayAllowanceComponent implements OnInit {
  amount: number = 1;
  checked = true;
  selectedValue = "January";
  selectedAllowance = "food";
  selectedSort = "Sort";
  searchText = "";
  ...
  public continuePayAllowance() {
    ...
    this.router.navigate(["/", "allowance", "confirm"]);
  }
}
