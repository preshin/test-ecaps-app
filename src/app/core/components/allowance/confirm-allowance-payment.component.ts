...
@Component({
  selector: "koppr-pot",
  templateUrl: "./confirm-allowance-payment.component.html",
  styleUrls: ["./confirm-allowance-payment.component.scss"]
})
export class ConfirmAllowancePaymentComponent implements OnInit {
  isVisible = false;
  ...
  handleOk(): void {
    ...
    setTimeout(() => {
      ...
      this.router.navigate(["/allowance", "allowancepaymentresponse"]);
      this.router;
    }, 3000);
  }
