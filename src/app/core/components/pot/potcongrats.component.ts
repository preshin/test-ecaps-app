...
@Component({
  selector: 'koppr-potcongrats-component',
  templateUrl: './potcongrats.component.html',
  styleUrls: ['./potcongrats.component.scss']
})
export class  PotCongratsComponent  implements OnInit, OnDestroy {
