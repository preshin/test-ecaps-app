...
@Component({
  selector: 'koppr-view-component',
  templateUrl: './viewpot.component.html',
  styleUrls: ['./viewpot.component.scss']
})
export class ViewPotComponent  implements OnInit, OnDestroy {
