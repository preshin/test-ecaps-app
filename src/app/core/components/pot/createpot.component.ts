...
@Component({
  selector: "koppr-create-component",
  templateUrl: "./createpot.component.html",
  styleUrls: ["./createpot.component.scss"]
})
export class CreatePotComponent implements OnInit, OnDestroy {
