...
@Component({
  selector: 'koppr-transferfromto-component',
  templateUrl: './transferfromto.component.html',
  styleUrls: ['./transferfromto.component.scss']
})
export class TransferFromToComponent  implements OnInit, OnDestroy {
