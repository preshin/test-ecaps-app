...
import { EMPLOYEE_CREATE, CATEGORY_BULK } from "@app/core/store/actions";
...
@Component({
  selector: "koppr-pot",
  templateUrl: "./bulk-category.component.html",
  styleUrls: ["./bulk-category.component.scss"]
})
export class BulkCategoryComponent implements OnInit {
  willDownload = false;
  jsonData = null;
  success: any;
  error: any;
